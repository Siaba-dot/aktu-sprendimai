...
if uploaded_file is not None:
    ...
    for idx, page in enumerate(pdf_reader.pages):
        ...
        if st.button(f"Išsaugoti aktą {idx+1} su kodu", key=f"button_{idx}"):
            ...
            # Paimam pirmas 3 raides iš skyriaus kodo
            first_three_letters = skyriaus_kodas[:3]

            # Sukuriam aplanką pagal pirmas 3 raides
            ...
            # Tikrinam ar failas jau yra, jei taip – pridedam numerį
            counter = 1
